...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    // createAgentSession can lazily resolve SessionManager and agent state.
    ...
    try {
      ...
      // FORK: publish the live session for compact-tool state refresh.
      ...
      try {
        ...
        try {
          ...
          // protect, so their inbound context stays inline exactly as before.
