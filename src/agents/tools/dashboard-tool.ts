...
export function createDashboardTool(opts: DashboardToolOptions = {}): AnyAgentTool {
  ...
  return {
    ...
    name: "dashboard",
    description:
      "Read and arrange this session dashboard: tabs, widgets, layout, sizes, chat dock. Actions: read, tab_create/tab_update/tab_delete/tabs_reorder/focus_tab, widget_put/widget_move/widget_resize/widget_remove, set_chat_dock. Widgets use stable names; plugin widgets via pluginKind+props. Sizes and plugin widget reference: skill openclaw-dashboard-layout.",
