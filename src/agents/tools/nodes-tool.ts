...
export function createNodesTool(options?: {
  ...
  return {
    ...
    name: "nodes",
    description:
      "Paired nodes: status/list/describe, pairing lifecycle, notify, capture (camera/screen/location), notifications, device info, which, invoke. Full action list: skill openclaw-paired-device-control.",
