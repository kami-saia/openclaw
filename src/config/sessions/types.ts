...
type MemoryFlushState =
  | {
      ...
      /**
       * FORK: Context size when this flush was signalled. Used to re-arm the
       * flush gate when the session keeps growing without a compaction landing
  ...
  | {
      ...
      compactionCount?: number;
      failureCount: number;
      /** FORK: see the succeeded variant. */
      totalTokens?: number;
    };
