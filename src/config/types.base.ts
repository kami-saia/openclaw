...
// FORK: upstream renamed the disabled mode to "none"; we keep "never" in the union because
// live configs persist `session.reset.mode: "never"`. Both mean "no automatic reset".
export type SessionResetMode = "none" | "daily" | "idle" | "never";
