  ...
  .object({
    ...
    compaction: z
      .object({
        enabled: z.boolean().optional(),
        mode: z
          // FORK: "agent" is our agent-driven compaction mode (compact-tool.ts,
          // overflow-context-recovery.ts gate on it). Upstream only ships
          // default|safeguard; keep the literal so AgentCompactionMode matches.
