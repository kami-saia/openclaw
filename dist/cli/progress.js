...
import { clearActiveProgressLine, registerActiveProgressLine, unregisterActiveProgressLine, } from "../terminal/progress-line.js";
...
export async function withProgress(options, work) {
...
export async function withProgressTotals(options, work) {
