 ...
 */
export declare function buildTelegramThreadParams(messageThreadId?: number): {
...
export declare function resolveTelegramStreamMode(telegramCfg: Pick<TelegramAccountConfig, "streamMode"> | undefined): TelegramStreamMode;
