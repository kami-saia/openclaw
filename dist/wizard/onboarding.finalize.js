    ...
    if (!opts.skipUi && gatewayProbe.ok) {
        ...
        if (hatchChoice === "tui") {
            ...
            if (seededInBackground) {
                await prompter.note(`Web UI seeded in the background. Open later with: ${formatCliCommand("openclaw dashboard --no-open")}`, "Web UI");
            }
        }
            ...
            await prompter.note(`When you're ready: ${formatCliCommand("openclaw dashboard --no-open")}`, "Later");
        }
    }
    else if (opts.skipUi) {
