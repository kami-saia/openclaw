...
import { applyResponsesSnapshotCollapse } from "./openai-responses-stream-collapse-internal.js";
      ...
      if (event.type === "response.created") {
        ...
        if (item.type === "reasoning" && outputSlot?.type === "thinking") {
          ...
          if (collapse.kind === "extend" && outputSlot.collapseCandidate) {
            ...
            applyResponsesSnapshotCollapse({
              stream,
              candidate: outputSlot.collapseCandidate,
              text: collapse.text,
